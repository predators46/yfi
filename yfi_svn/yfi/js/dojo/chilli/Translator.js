...
if(!dojo._hasResource["chilli.Translator"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["chilli.Translator"] = true;
dojo.provide("chilli.Translator");


(function(){

    var ct          = chilli.Translator;
