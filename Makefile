...
PKG_SOURCE_URL:=ftp://ftp.freeradius.org/pub/freeradius/old/
...
$(eval $(call BuildPlugin,freeradius2-mod-sqlippool,rlm_sqlippool,sqlippool.conf modules/dhcp_sqlippool,modules,))
